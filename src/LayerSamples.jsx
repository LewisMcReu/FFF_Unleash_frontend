...
export function PerPale() {
    return <svg viewBox="0 0 9 6">
        <rect width="100%" height="100%" fill="gray"/>
        <rect width="4.5" height="6" fill="red"/>
    </svg>;
}

export function PerFess() {
    return <svg viewBox="0 0 9 6">
        <rect width="100%" height="100%" fill="gray"/>
        <rect width="9" height="3" fill="red"/>
    </svg>;
}

export function PerBend() {
    return <svg viewBox="0 0 9 6">
        <rect width="100%" height="100%" fill="gray"/>
        <polygon points="0,0 9,0 9,6" fill="red"/>
    </svg>;
}

export function PerBendSinister() {
    return <svg viewBox="0 0 9 6">
        <rect width="100%" height="100%" fill="gray"/>
        <polygon points="0,0 9,0 0,6" fill="red"/>
    </svg>
}
...
export function Pale() {
    return <svg viewBox="0 0 9 6">
        <rect width="100%" height="100%" fill="gray"/>
        <rect x="35%" width="30%" height="100%" fill="red"/>
    </svg>
}

export function Fess() {
    return <svg viewBox="0 0 9 6">
        <rect width="100%" height="100%" fill="gray"/>
        <rect y="2" width="9" height="2" fill="red"/>
    </svg>
}
...
export function Bend() {
    return <svg viewBox="0 0 9 6">
        <rect width="100%" height="100%" fill="gray"/>
        <rect y="2" x="-2" width="12" height="2" transform="rotate(33.69,4.5,3)" fill="red"/>
    </svg>
}

export function BendSinister() {
    return <svg viewBox="0 0 9 6">
        <rect width="100%" height="100%" fill="gray"/>
        <rect y="2" x="-2" width="12" height="2" transform="rotate(-33.69,4.5,3)" fill="red"/>
    </svg>
...
export function Side() {
    return <svg viewBox="0 0 9 6">
        <rect width="100%" height="100%" fill="gray"/>
        <rect width="30%" height="6" fill="red"/>
    </svg>
}

export function SideSinister() {
    return <svg viewBox="0 0 9 6">
        <rect width="100%" height="100%" fill="gray"/>
        <rect width="30%" x="70%" height="6" fill="red"/>
    </svg>
}
...
export function Base() {
    return <svg viewBox="0 0 9 6">
        <rect width="100%" height="100%" fill="gray"/>
        <rect y="70%" width="100%" height="30%" fill="red"/>
    </svg>
}

export function PerCross() {
    return <svg viewBox="0 0 9 6">
        <rect width="100%" height="100%" fill="gray"/>
...
export function PerSaltire() {
    return <svg viewBox="0 0 9 6">
        <rect width="100%" height="100%" fill="gray"/>
        <polygon points="0,0 4.5,3 9,0 9,6 4.5,3 0,6" fill="red"/>
    </svg>
}

export function CoupedCross() {
    return <svg viewBox="0 0 9 6">
        <rect width="100%" height="100%" fill="gray"/>
        <rect x="4" y="1" width="1" height="4" fill="red"/>
        <rect x="2.5" y="2.5" width="4" height="1" fill="red"/>
    </svg>
}

export function SymmetricCross() {
    return <svg viewBox="0 0 9 6">
        <rect width="100%" height="100%" fill="gray"/>
        <rect x="4" width="1" height="6" fill="red"/>
        <rect y="2.5" width="9" height="1" fill="red"/>
    </svg>
}

export function NordicCross() {
    return <svg viewBox="0 0 9 6">
        <rect width="100%" height="100%" fill="gray"/>
        <rect x="3" width="1" height="6" fill="red"/>
        <rect y="2.5" width="9" height="1" fill="red"/>
    </svg>
}

export function Saltire() {
    return <svg viewBox="0 0 9 6">
        <rect width="100%" height="100%" fill="gray"/>
        <rect y="2.5" x="-2" width="12" height="1" transform="rotate(-33.69,4.5,3)" fill="red"/>
        <rect y="2.5" x="-2" width="12" height="1" transform="rotate(33.69,4.5,3)" fill="red"/>
    </svg>
}
...
export function Bordure() {
    return <svg viewBox="0 0 9 6">
        <rect width="100%" height="100%" fill="gray"/>
        <rect width="9" height="1" fill="red"/>
        <rect width="1" height="6" fill="red"/>
        <rect y="5" width="9" height="1" fill="red"/>
        <rect x="8" width="1" height="6" fill="red"/>
    </svg>
}
...
export function Pile() {
    return <svg viewBox="0 0 9 6">
        <rect width="100%" height="100%" fill="gray"/>
        <polygon points="0,0 4.5,3 0,6" fill="red"/>
    </svg>
}

export function PileThroughout() {
    return <svg viewBox="0 0 9 6">
        <rect width="100%" height="100%" fill="gray"/>
...
export function Stripes() {
    return <svg viewBox="0 0 9 6">
        <rect width="100%" height="100%" fill="gray"/>
        <rect y=".667" width="100%" height=".667" fill="red"/>
        <rect y="2" width="100%" height=".667" fill="red"/>
        <rect y="3.333" width="100%" height=".667" fill="red"/>
        <rect y="4.667" width="100%" height=".667" fill="red"/>
    </svg>
}

export function VerticalTriband() {
    return <svg viewBox="0 0 9 6">
        <rect width="3" height="6" fill="red"/>
        <rect x="3" width="3" height="6" fill="green"/>
        <rect x="6" width="3" height="6" fill="blue"/>
    </svg>
}

export function HorizontalTriband() {
    return <svg viewBox="0 0 9 6">
        <rect width="9" height="2" fill="red"/>
        <rect y="2" width="9" height="2" fill="green"/>
        <rect y="4" width="9" height="2" fill="blue"/>
    </svg>
}
...
export function Star() {
    return <svg viewBox="0 0 9 6">
        <rect width="100%" height="100%" fill="gray"/>
        <svg viewBox="0 0 260 245" x="35%" y="35%" width="30%" height="30%" fill="red">
...
export function MapleLeaf() {
    return <svg viewBox="0 0 9 6">
        <rect width="100%" height="100%" fill="gray"/>
        <svg x="25%" y="25%" width="50%" height="50%" viewBox="-2015 -2000 4030 4030"
             fill="red">
            <path
...
export function NASA() {
    return <svg viewBox="0 0 9 6">
        <rect width="100%" height="100%" fill="gray"/>
        <svg viewBox="0 0 110 92" height="65%" width="90%" x="5%" y="17.5%">
